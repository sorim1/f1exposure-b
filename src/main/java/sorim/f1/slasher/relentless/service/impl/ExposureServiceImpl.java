...
//        return closeExposurePollLegacy();
//    }
//
//    private boolean closeExposurePollLegacy() {
//        exposureToday = false;
//        exposureNow = false;
...
//    }
//
//    private boolean closeExposurePollStrawpoll() {
//        exposureToday = false;
//        exposureNow = false;
//        ActiveExposureChart exposedData = getExposedChartData();
//        List<ExposureChampionship> list = new ArrayList<>();
...
//
//    @Override
//    public Boolean fetchStrawpollResults() {
//        StrawpollModel strawPoll = restTemplate
//                .getForObject(strawpollUrl, StrawpollModel.class);
//        log.info(String.valueOf(currentExposureRound));
//        log.info(String.valueOf(strawPoll));
//        return true;
//    }
